...
start = time.time()
single_model_path = './models/single_six_class_models/model.h5'
single_model_weights_path = './models/single_six_class_models/weights.h5'
single_model = load_model(single_model_path)
single_model.load_weights(single_model_weights_path)	
#Define Path
start = time.time()
